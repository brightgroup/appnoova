...
export function normalizeVoiceAgentForm(
  ...
  return {
    ...
    voice_provider: raw.voice_provider === "elevenlabs" ? "elevenlabs" : "google",
    elevenlabs_agent_id: raw.elevenlabs_agent_id ? String(raw.elevenlabs_agent_id) : null,
    elevenlabs_voice_id: raw.elevenlabs_voice_id ? String(raw.elevenlabs_voice_id) : null,
