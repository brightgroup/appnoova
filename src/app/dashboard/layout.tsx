        ...
        <nav className={`flex-1 ${sidebarOpen ? "p-3 space-y-1" : "p-3 space-y-3"} overflow-y-auto scrollbar-thin`}>
          ...
          <div>
            ...
            {sidebarOpen && expandedMenu === "texto" && (
              <div className="ml-8 mt-1 space-y-1.5 pb-2 border-l border-white/[.1]">
                {[{ name: "Agentes", href: "/dashboard/agentes-texto" }, { name: "Mi link", href: "/dashboard/micrositio" }, { name: "Inbox", href: "#" }, { name: "Text Logs", href: "#" }, { name: "Equipos", href: "#" }, { name: "Plantillas", href: "#" }, { name: "Canales", href: "/dashboard/micrositio/configuracion?tab=general" }].map((item, i) => (
