...
export function PremiumVoiceAvatar({ initial }: PremiumVoiceAvatarProps) {
  return (
    <div className="relative flex items-center justify-center w-[76px] h-[76px]">
      <div className="nv-voice-avatar w-[64px] h-[64px] rounded-full flex items-center justify-center shadow-[0_0_18px_rgba(143,164,232,0.14)]">
        <span className="nv-voice-avatar-initial text-[1.5rem] font-semibold leading-none select-none tracking-[-0.02em]">
          {initial}
        </span>
      </div>
    </div>
