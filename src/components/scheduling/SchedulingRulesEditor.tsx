          ...
          <div className="mt-5 pt-5 border-t border-white/[.08] space-y-4">
            ...
            <div className="flex items-center justify-between rounded-xl bg-white/[.03] border border-white/[.06] px-4 py-3">
              ...
              <Link
                ...
                className="inline-flex items-center gap-1.5 text-[11px] font-medium text-[#5b5bf6] hover:text-[#a5a5ff] shrink-0"
              >
    ...
    <div>
      ...
      <div className="relative">
        <input
          ...
          className="w-full px-3 py-2.5 rounded-xl bg-noova-surface border border-white/[.08] text-sm text-white focus:outline-none focus:border-[#5b5bf6]/40 pr-12"
        />
        ...
        {presets.map(p => (
          <button
            ...
            className={`px-2.5 py-1 rounded-lg text-[11px] font-medium border transition-colors ${
              value === p
                ? "bg-[#5b5bf6]/20 border-[#5b5bf6]/40 text-white"
