...
export function GeminiLogo({ mono, ...props }: SVGProps<SVGSVGElement> & {
  /** Sin el degradé de marca, heredando currentColor — para insignias
   *  monocromas donde el color lo pone el tema. */
  mono?: boolean;
}) {
