-- Sincronizar organizations.plan con la suscripción (incluye planes custom como vip).

-- Backfill: orgs con suscripción distinta a organizations.plan
...
where s.organization_id = o.id
  ...
  and o.plan is distinct from s.plan_id;

-- billing_bootstrap_subscription: actualizar organizations.plan
...
-- billing_admin_update_subscription: mantener organizations.plan alineado
