...
import { appPath } from "@/lib/marketing-api";
...
function LandingPageContent({ homeHref = "/iaseguros" }: { homeHref?: string }) {
  return (
    <div className="min-h-screen bg-[#06070d] text-white">
      <header className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between h-14 px-6 bg-[#06070d]/80 backdrop-blur-xl border-b border-white/[.06]">
        <div className="flex items-center gap-3">
          <Link href={homeHref} className="relative h-8 w-28 sm:w-32 flex-shrink-0">
            <Image
              src="/logo-noova.png"
              alt="Noova 360"
              fill
      ...
      <main className="relative z-10" style={{ paddingTop: "5.5rem" }}>
        ...
        <PricingSection variant="insurance" />
      ...
      <footer className="border-t border-white/[.06] py-12 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-6xl">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
            <div>
              <Link href={homeHref} className="relative block h-8 w-28 mb-4">
                <Image
                  src="/logo-noova.png"
                  alt="Noova 360"
                  fill
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-500">
                <li>
                  <Link href={appPath("/login")} className="hover:text-white transition-colors">
                    Ingresar
                  </Link>
                </li>
              </ul>
...
export default function IaSegurosLandingPage() {
  return (
    <LeadCaptureProvider>
