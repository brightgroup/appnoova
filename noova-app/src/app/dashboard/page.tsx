...
import { LogOut, Settings, Bell, Search, ChevronLeft, ChevronRight, BarChart3, Radio, MessageSquare, Target, Bot, CreditCard, MessageCircle, Zap, Phone } from "lucide-react";
    ...
    <div className="flex h-screen bg-[#0d0e14] text-white">
      ...
      <div className={`${sidebarOpen ? "w-64" : "w-20"} bg-[#09090f] border-r border-white/[.08] transition-all duration-300 flex flex-col overflow-hidden`}>
        ...
        <div className={`p-4 border-b border-white/[.08] flex items-center ${sidebarOpen ? "justify-between" : "justify-center"}`}>
          {sidebarOpen && <span className="font-bold text-lg tracking-tight">Noova 360</span>}
          <button
      ...
      <div className="flex-1 flex flex-col">
        {/* Top Bar */}
        <div className="h-16 border-b border-white/[.06] bg-[#0d0e14]/50 backdrop-blur flex items-center justify-between px-6">
